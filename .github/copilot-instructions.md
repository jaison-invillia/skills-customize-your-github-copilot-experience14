...
Utilizamos conventional commits para todas as mensagens de commit. Alguns exemplos:

- `feat: add filtering for upcoming assignments`
- `fix: correct link to data-analysis starter`
- `docs: update instructions for contributors`
- `chore: bump dependencies and format`
